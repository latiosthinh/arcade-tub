...
export const GAMES: GameItem[] = [
  ...
  },
  {
    ...
    genre: 'Grid Action',
    description: 'Classic storybook caterpillar adventure. Collect juicy red apples and golden honey fruit to grow your caterpillar.',
    badge: 'Classic',
    rating: '4.9 ★',
    plays: '710K plays',
    icon: '🐛',
  ...
  },
  {
    ...
    description: 'Heartwarming tree climbing reflex action. Tap Left or Right to switch sides on the big oak trunk and dodge oncoming branch hazards.',
    badge: 'Fast Paced',
    rating: '4.8 ★',
    plays: '380K plays',
    icon: '🐞',
  ...
  },
  {
    ...
    description: 'Multi-lane vintage highway racer. Steer your classic roadster across lanes, throttle speed with Space, and draft traffic for bonuses.',
    badge: 'High Speed',
    rating: '4.9 ★',
    plays: '520K plays',
    icon: '🚗',
